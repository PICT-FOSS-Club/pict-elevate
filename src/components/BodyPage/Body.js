...
import Budhani from "../../images/Budhani.png";
    ...
    <div className="body">
      ...
      <div className="SponsorSect">
        ...
        <div className="sponsbox">
          ...
          <img className="spimg" src={Budhani} alt=""/>
          </Fade>
          <Fade right duration={2200}>
          <img className="spimg" src={decathlon} alt=""/>
          </Fade>
        </div>
      </div>
      </Fade>
      ...
      <div className="Brochure">
        ...
        <div>
          <button className="endbtn">
            <a className="dwnlink" href="https://drive.google.com/file/d/1fL2VpUDuDcj-YFTzFjKwZkTBwCnqe-NT/view?usp=sharing" download={true}>Download Brochure<img className="dwnimg" src={download} alt="" width="40px"/></a>
          </button>
        </div>
      </div>
      ...
      <div id="btn">
         <button className='endbtn' onClick={Scroll}>Scroll up <img src={uparrow} width="20px"/></button>
      </div>
