...
const Team = () => {
  ...
  <div className="responsive-container-block">
    ...
    <div className="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 card-container">
      <div className="card">
        <div className="team-image-wrapper">
          <img className="team-member-image" src={Digvijay} />
        </div>
        ...
        <div className="social-icons">
            <a href="https://www.instagram.com/digvijay_mrperfect/" target="_blank">
              <img src={instagram} alt="" width="40px" />
            </a>
            <a href="https://www.linkedin.com/in/digvijay-shingare-373373237/" target="_blank">
    ...
    <div className="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 card-container">
      <div className="card">
        <div className="team-image-wrapper">
          <img className="team-member-image" src={Ashutosh} />
        </div>
        <p className="text-blk name">
          Ashutosh Birajdar
        </p>
        ...
        <div className="social-icons">
            <a href="https://instagram.com/spiritual.being.369?igshid=YmMyMTA2M2Y=" target="_blank">
              <img src={instagram} alt="" width="40px" />
            </a>
            <a href="https://www.linkedin.com/in/ashutosh-birajdar" target="_blank">
              <img src={LinkedIn} alt="" width="40px" />
            </a>
        </div>
      </div>
