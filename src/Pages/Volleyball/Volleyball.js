  ...
  return (
    ...
    <div className='page'>
        ...
        <div className='Regfees'>
          ...
          <div className='feesSect'>
            <Fade left duration={2000}>
              <div className='fees'>
                 <img src={boy} className="feesimg"/>
                 Boys team: <span>1800/- </span>
              </div>
            </Fade>
            <Fade right duration={2000}>
              <div className='fees'>
                <img src={girl} className="feesimg"/>
        ...
        <div className='Regbtn'>
          <img src={finger} className="feesimg"/>
        ...
        <div className='prizeSect'>
          ...
          <p>All participants will receive certificates. Winners will receive Trophy<img src={trophy} width="40px" /> , individual awards and cash prizes. </p> 
        </div>
        </Fade>
